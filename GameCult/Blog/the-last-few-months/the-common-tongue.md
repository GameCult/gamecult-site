...
- cultcache-rs crate (`4e95543`), cultnet-rs wire parity (`ab86857`), and CultNetTS wire parity (`902f966`). Those standalone repositories were later folded into [CultLib](https://github.com/GameCult/CultLib) and removed.
