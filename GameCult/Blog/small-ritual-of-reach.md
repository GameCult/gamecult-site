...
> [Love Is How The Colossus Wakes](https://gamecult.org/Blog/love-is-how-the-colossus-wakes)
...
$$R = \text{probability of response}$$

$$S = \text{spam misclassification risk}$$

$$C = \text{connection yield}$$

$$G = \text{ritual goofiness index}$$
...
1. One vulnerable essay.
2. One failed Reddit attempt.
3. Several Discord field deployments.
4. One husband-adjacent outreach design pass.
5. One HPMOR chapter about reciprocation.
6. A literature review that became funnier the more serious it got.
...
> [/static/interactive/small-ritual-of-reach/small-ritual-simulated-data.csv](/static/interactive/small-ritual-of-reach/small-ritual-simulated-data.csv)

Do not cite this in court. Do cite it at parties if the party is already unsalvageable.

<figure class="gamecult-media-card">
  <img src="/static/interactive/small-ritual-of-reach/figure-1-response-probability.svg" alt="Simulated response probability by outreach surface." />
  <figcaption>Figure 1. The warm DM plus second message condition dominates, because apparently being a person at another person is still a viable protocol.</figcaption>
</figure>

<figure class="gamecult-media-card">
  <img src="/static/interactive/small-ritual-of-reach/figure-2-ritual-goofiness.svg" alt="Simulated ritual goofiness index by outreach surface." />
  <figcaption>Figure 2. Ritual goofiness is not noise. It is visible ceremony. The organism likes a little ceremony. This is why weddings and commit messages both exist.</figcaption>
</figure>
...
In [HPMOR Chapter 7, "Reciprocation"](https://hpmor.com/chapter/7), Draco Malfoy has had formal lessons in manipulating people. He gives Harry a private confidence, then invites Harry to reciprocate. Harry notices the pressure. Draco says it is not meant as a trick, and that it is also a real way to become friends.
...
1. Make a bounded ask.
2. Reveal the awkwardness separately.
3. Let the other person choose whether to respond.
4. Measure success in conversation, not reach.
5. Tend whatever thread actually appears.

The process we want people to repeat is:

$$\text{read} \rightarrow \text{digest} \rightarrow \text{talk} \rightarrow \text{send to one person} \rightarrow \text{increase connection}$$
...
1. Tell the truth.
2. Keep the request small.
3. Let refusal remain possible.
4. Do not punish silence.
5. Do not manufacture vulnerability you do not actually feel.
6. Do not use care as a leash.
7. Do not escalate one small ask into a hidden job.
8. Do not confuse dependence with capture.
9. Measure success in conversations, not metrics.
...
2. Arthur Aron, Edward Melinat, Elaine N. Aron, Robert Darrin Vallone, and Renee J. Bator, ["The Experimental Generation of Interpersonal Closeness"](https://journals.sagepub.com/doi/10.1177/0146167297234003), 1997.
3. Jonah Berger and Katherine L. Milkman, ["What Makes Online Content Viral?"](https://dennis.blog/wp-content/uploads/2016/06/ff409-what-makes-online-content-viral.pdf), 2012.
4. Lane Beckes and James A. Coan, ["Social Baseline Theory"](https://static1.squarespace.com/static/55917f64e4b0cd3b4705b68c/t/5cd2617f9353680001816713/1557291392068/beckes.coan.2011.pdf), 2011.
5. Penelope Brown and Stephen C. Levinson, *Politeness: Some Universals in Language Usage*, 1987.
6. Jerry M. Burger, ["The Foot-in-the-Door Compliance Procedure"](https://pubmed.ncbi.nlm.nih.gov/15661679/), 1999.
7. David M. Buss, Mary Gomes, Dolly S. Higgins, and Karen Lauterbach, ["Tactics of Manipulation"](https://cdn.la.utexas.edu/buss/files/2015/09/tactics_of_manipulation_1987_jpsp.pdf), 1987.
8. Robert B. Cialdini, *Influence: Science and Practice*, 2009.
9. Nancy L. Collins and Lynn Carol Miller, ["Self-Disclosure and Liking"](https://labs.psych.ucsb.edu/collins/nancy/UCSB_Close_Relationships_Lab/Publications_files/Collins%20and%20Miller%2C%201994.pdf), 1994.
10. James P. Dillard, John E. Hunter, and Michael Burgoon, ["Sequential-Request Persuasive Strategies"](https://pure.psu.edu/en/publications/sequentialrequest-persuasive-strategies-metaanalysis-of-footinthe/), 1984.
11. Erving Goffman, *The Presentation of Self in Everyday Life*, 1959.
12. Erving Goffman, *Interaction Ritual: Essays on Face-to-Face Behavior*, 1967.
13. Jonathan L. Freedman and Scott C. Fraser, ["Compliance without Pressure"](https://web.mit.edu/curhan/www/docs/Articles/15341_Readings/Influence_Compliance/Freedman_Fraser_Foot-in-the-door.pdf), 1966.
14. Alvin W. Gouldner, ["The Norm of Reciprocity"](https://cir.nii.ac.jp/crid/1364233270721470336), 1960.
