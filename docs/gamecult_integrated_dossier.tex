...
Launch a 12-month fellows program only after the external work loop is producing measured results. The purpose would be to test whether stability plus agent access increases output.
