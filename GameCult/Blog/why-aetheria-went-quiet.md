...
*"The project did not vanish because the idea was small. It went quiet because the idea became expensive in all the least romantic ways."*
...
There were attempts to scope the thing down before and after that wall. Terminus was already a retreat from the full galaxy-scale design: a rogue-lite route through hostile space instead of the whole persistent economy at once. When even that looked too large, one of the strongest last-ditch cuts was `L'appel du Vide`, a story-first Aetheria concept about Cat Marrigan, a private investigator and taxi driver working through curated cases while the displaced fleet realizes Elysium is not offering return tickets. It was the right instinct: fewer procedural promises, more authored density, a human-scale way into the same political and emotional machinery.
...
That means Aetheria now has its own public home at [aetheria.gamecult.org](https://aetheria.gamecult.org), where the lore, fiction, design documents, media, and current release path can live together. The immediate path is smaller and sharper: prove playable slices, keep the open model intact, make the work visible again, and stop asking one overextended person to personally fistfight economic reality in a conference hallway. Terminus cuts the monster down once. `L'appel du Vide` cuts again if the first cut is still too heavy to lift. Lessons were learned. Some of them had teeth.
