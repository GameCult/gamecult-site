...
<figure class="gamecult-media-card">
  <img src="../media/studio/bounty.jpg" alt="A bounty board style image from the legacy GameCult site." />
  <p>The original pitch was simple: if a task exists, people should be able to see it, volunteer for it, and be rewarded for completing it.</p>
</figure>
